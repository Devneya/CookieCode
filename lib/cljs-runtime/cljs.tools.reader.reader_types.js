...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_7998 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_7998(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_8001 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_8001(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_8008 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_8008(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_8013 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_8013(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_8016 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_8016(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_8021 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_8021(reader);
}
});
...
var G__8095 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__8096 = s.append(c);
c = G__8095;
s = G__8096;
continue;
}
